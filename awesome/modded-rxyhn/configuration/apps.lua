...
return {
	...
	default = {
		...
		music_player = "LIBGL_ALWAYS_SOFTWARE=1 alacritty --class music -e ncmpcpp",
		--- Default text editor
		text_editor = "LIBGL_ALWAYS_SOFTWARE=1 alacritty -e nvim",
		--- Default code editor
		code_editor = "codium",
		--- Default web browser
		web_browser = "firefox",
		...
		network_manager = "LIBGL_ALWAYS_SOFTWARE=1 alacritty -e nmtui",
